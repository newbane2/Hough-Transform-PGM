/*
    Allan Spektor
    H4
    Applies a threshold to divide into clusters
    and then uses a breadth first search to find the local maxima of a cluster, then sets everything else to 0
    then convert the hough space cluster maxima into 2 points, and then draw a line
    as input takes in a pgm file and a hough space vote array and outputs a pgm file with above specification
*/
